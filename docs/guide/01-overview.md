...
**Laravel SSLCommerz** is a developer-focused package for integrating SSLCommerz payments into your Laravel applications. It provides a clean, fluent API that wraps the complexity of the SSLCommerz gateway into simple method chains and typed response objects.

## Key Features

- **Fluent API**: Chain your order, customer, and shipping details seamlessly.
- **Payload Merging**: Easily pass extra metadata (value_a through value_f) to track your custom identifiers.
